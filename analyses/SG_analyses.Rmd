...
#two sites predicted differently, 
...
# ---- CROSS-VALIDATION ----
lda_cv <- lda(site_type ~ macro_stipe_density_ + density_macstump + density_ptecal + density_nerlue + density_lamset + density_eisarb + purple_urchin_densitym2 + purple_urchin_conceiledm2 + lamr_densitym2 + macr_densitym2 + macj_densitym2 + nerj_densitym2 + ptej_densitym2 + lsetj_densitym2  + tegula_densitym2 + cov_articulated_coralline + cov_crustose_coralline + cov_encrusting_red + cov_fleshy_red + cov_stephanocystis + cov_dictyoneurum_spp + cov_dictyota_dictyopteris + cov_desmarestia_spp,
              data = year_one_data,
              CV = TRUE)
...
for (i in 1:n_perm) {
  ...
  lda_perm <- lda(site_type ~ macro_stipe_density_ + density_macstump + density_ptecal + density_nerlue + density_lamset + density_eisarb + purple_urchin_densitym2 + purple_urchin_conceiledm2 + lamr_densitym2 + macr_densitym2 + macj_densitym2 + nerj_densitym2 + ptej_densitym2 + lsetj_densitym2  + tegula_densitym2 + cov_articulated_coralline + cov_crustose_coralline + cov_encrusting_red + cov_fleshy_red + cov_stephanocystis + cov_dictyoneurum_spp + cov_dictyota_dictyopteris + cov_desmarestia_spp,
                  data = shuffled,
                  CV = TRUE)
...
lda_model_transect <- lda(site_type ~ macro_stipe_density_ + density_macstump + density_ptecal + density_nerlue + density_lamset + purple_urchin_densitym2 + purple_urchin_conceiledm2 + lamr_densitym2 + macr_densitym2 + macj_densitym2 + nerj_densitym2 + ptej_densitym2 + lsetj_densitym2  + tegula_densitym2 + cov_articulated_coralline + cov_crustose_coralline + cov_encrusting_red + cov_fleshy_red + cov_stephanocystis + cov_dictyoneurum_spp + cov_dictyota_dictyopteris + cov_desmarestia_spp, data = year_one_data_transect)
...
table(Actual = year_one_data_2$site_type, Predicted = pred_class_transect)
...
mean(pred_transect$class == year_one_data_transect$site_type)
```
