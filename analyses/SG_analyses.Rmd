...
librarian::shelf("tidyverse", "vegan", "ggplot2", "dplyr", "car", "ggpubr", "minpack.lm", "googledrive", "janitor", "nlme", "RColorBrewer", "splitstackshape", "lubridate", "matrixStats", "readr", "stringr")
...
#FIG 3: Boxplots representing change in functional groups across patch transitions 
...
###Stats (ANOVA)
```{r}
# Example: all functional groups
raw_groups <- functional_groups %>%
  dplyr::select(site, zone, year, first_stage:purple_urchin_conceiled) %>%
  pivot_longer(cols = first_stage:purple_urchin_conceiled,
               names_to = "functional_group",
               values_to = "value")
...
```
#proportion conceiled and compare in 2024 patches vs 2025 transitioned 
#proportional abundance graph of kelps to look at community composition? 