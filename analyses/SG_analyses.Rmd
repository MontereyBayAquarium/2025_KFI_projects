...
comm_cols <- c(
  ...
  "purple_urchin_densitym2", "red_urchin_densitym2", "lamr_densitym2",
  "macr_densitym2", "macj_densitym2", "nerj_densitym2", "ptej_densitym2",
  "lsetj_densitym2", "eisj_densitym2",
...
env_vars <- c("risk", "relief", "purple_urchin_densitym2", "purple_urchin_conceiledm2",
              "tegula_densitym2", "pomaulax_densitym2", "zone")
env_matrix <- bar_incip_for[, env_vars]

# --- 3. Run RDA ---
rda_model <- rda(comm_hellinger ~ risk + relief + purple_urchin_densitym2 +
